...
class IconMain extends StatefulWidget {
  final String userId;

  const IconMain({super.key, required this.userId});

  @override
  State<IconMain> createState() => _IconMainState();
}

class _IconMainState extends State<IconMain> {
          ...
          onTap: () async {
            ...
            if (userType == '11' || userType == '12') {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => IOCMDocs(userId: widget.userId)),
              );
            } else {
