...
class shipdethist extends StatefulWidget {
  // const shipdethist({super.key});
  final String userId;

  const shipdethist({super.key, required this.userId});

  @override
  State<shipdethist> createState() => _shipdethistState();
}

class _shipdethistState extends State<shipdethist> {
  ...
  Future<void> fetchDeficiencies() async {
    try {
      final response = await http
          .get(Uri.parse('$serverPath/get_imo_name_det.php?identity=false'));
  ...
  Future<void> fetchShipDetails(String inspNo) async {
    ...
    try {
      final response = await http
          .get(Uri.parse('$serverPath/get_det_details.php?insp_no=$inspNo'));
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _buildDetailTitle('Detention History'),
              ],
            ),
            const SizedBox(height: 10),
            Table(
                          ...
                          children: [
                            TextSpan(
                              ...
                              style: TextStyle(
                                ...
                                fontWeight: FontWeight.bold,
                                color: Colors
                                    .red, // Red color for "Date of Detention"
                              ),
                            ),
                            TextSpan(
                              text: '\n & \n',
                            ...
                            TextSpan(
                              ...
                              style: TextStyle(
                                ...
                                fontWeight: FontWeight.bold,
                                color: Colors
                                    .green, // Green color for "Date of Release"
                              ),
                            ),
                          ],
                        ),
                        ...
                        child: Center(
                          ...
                          child: Text.rich(
                            TextSpan(
                              children: [
                                TextSpan(
                                  text: '${detentionData['det_date']}\n',
                                  style: TextStyle(
                                    fontFamily: 'Arial',
                                    fontSize: 12,
                                    color: Colors
                                        .red, // Red color for detention date
                                  ),
                                ),
                                TextSpan(
                                  text: detentionData['rel_date'],
                                  style: TextStyle(
                                    fontFamily: 'Arial',
                                    fontSize: 12,
                                    color: Colors
                                        .green, // Green color for release date
                                  ),
                                ),
                              ],
                            ),
